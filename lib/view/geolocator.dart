...
class _GeolocatorWidgetState extends State<GeolocatorWidget> {
  ...
  PopupMenuButton _createActions() {
    return PopupMenuButton(
        ...
        itemBuilder: (context) => [
              ...
              if (Platform.isIOS)
                const PopupMenuItem(
                    value: 2, child: Text('Request Temporary Full Accuracy')),
  ...
  Widget build(BuildContext context) {
    ...
    return BaseFlowPluginExample(appBarActions: [
      _createActions()
    ], pages: [
      ExamplePage(
        Icons.location_on,
...
class BaseFlowPluginExample extends StatelessWidget {
  ...
  const BaseFlowPluginExample({
    super.key,
    this.appBarActions = const [],
    required this.pages,
  });

  /// Utility method to create a MaterialColor.
